...
export default function PersonasAuditPage() {
                ...
                <motion.div variants={staggerContainer} initial="hidden" animate="visible" className="space-y-8">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-neutral-400 mt-2">
                                Integrating specific user perspectives into the design process.
                            </p>
                        </div>
                    </div>
                    ...
                    <motion.div variants={fadeIn} className="glass rounded-xl border border-white/10 p-8">
                        <div className="flex items-center justify-between">
                            <div>
                                <h2 className="text-xl font-semibold text-white">Persona Score</h2>
                                <p className="text-sm text-neutral-400">Alignment with target user needs</p>
                            </div>
                            <div className="text-right">
                                <div className="text-4xl font-bold text-orange-500">{score}/100</div>
                                <div className="text-sm text-neutral-400">{findings.length} personas analyzed</div>
                            </div>
                        </div>
                    </motion.div>
